        ...
        if (allApproved) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    insert_purchase_order(po_order_to, po_delivery_to, po_terms, po_materials, "1", res.download_url);
                },
                error: function (xhr) {
            ...
            insert_purchase_order(po_order_to, po_delivery_to, po_terms, po_materials, "0", "");
        }
            ...
            if (response.trim() != "error") {
                ...
                obj.forEach(function (obj) {
                    ...
                    mat.forEach(function (mat) {
                        ...
                        $("#po_dashboard").append(
                            "<tr data-batch_id='" + mat.batch_id + "' data-uom='" + mat.uom + "' data-raw_material_rate='" + mat.material_rate + "' data-gst_rate='" + mat.gst + "' data-approve='" + mat.is_approved + "'>" +
...
function insert_purchase_order(po_order_to, po_delivery_to, po_terms, po_materials, po_email, po_path) {
        ...
        success: function (response) {
            ...
            if (response.trim() != "error") {
                ...
                obj.forEach(function (obj) {
                    ...
                    var edit = "<i class='fa-solid fa-print pe-3'  data-po_path=" + obj.po_path + "></i>"
                    ...
                    if (obj.email_sent == '0' && obj.approve_sts == '1') {
                        edit += "<i class='fa-solid fa-envelope-circle-check text-danger ps-3'></i>";
                    }
