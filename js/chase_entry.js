...
$(document).ready(function () {
    ...
    $("#sale_order").on("change", function(){
        ...
        var sub_type = selectedOption.data("sub_type");
        var date_f = selectedOption.data("date_f");
        var product = selectedOption.data("product");
        var model = selectedOption.data("model");
        var cus_name = selectedOption.data("cus_name");
        var type = selectedOption.data("type");
        var sale_order_id = selectedOption.val();

        $("#dc_no").text(sale_order_id);
        $("#dc_date").text(date_f);
        $("#model").text(model);
        $("#type").text(type);
    ...
    $("#chase_entry_preview_btn").on("click", function () {
        $("")
        $("#chase_entry_table").toggleClass("d-none")
    })
        ...
        success: function (response) {
            ...
            if (response.trim() != 'error') {
                ...
                obj.forEach(function (obj) {
                    ...
                    $("#sale_order").append("<option value=" + obj.ass_id + " data-sub_type=" + obj.sub_type + " data-date_f=" + obj.date_f + " data-product=" + obj.product + " data-model=" + obj.model + " data-cus_name=" + obj.cus_name + " data-type=" + obj.type + ">" + obj.cus_name + "-" + obj.product + " sale order no-" + obj.order_no + "</option>")
                });
