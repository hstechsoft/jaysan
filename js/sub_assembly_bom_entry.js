...
if($('#part_no_out').val() !="" && $('#part_name_out').val() &&  $("#bom_list_select").val()  )
 {
...
$.ajax({
  ...
  url: 'php/insert_sub_assembly_bom.php',
  method: 'POST',
  data: {
      
      inputPartsData: inputPartsData,
   
      output_part_no : $('#part_no_out').val(),
      output_part_name : $('#part_name_out').val(),
  ...
  $('#update_btn').on('click', function() {
    ...
    $.ajax({
      ...
      url: 'php/update_sub_assembly_bom.php',
      method: 'POST',
      data: {
...
$("#bom_recent_list").append("<li data-part_id='"+ obj.part_id+"' data-part_no='"+ obj.part_no+"' data-cat='"+ obj.component_cat+"'  class='list-group-item'>"+obj.part_name+"("+ obj.component_cat+ ")"+"</li>")
  });
