...
$(document).ready(function () {
  ...
  $("#received_btn").on("click", function (event) {
    var sts_array = [];
    if ($(this).is(":checked")) {
      $("#all_btn").prop("checked", false);
...
function get_material_request_form_list(sts_array, emp_id, receive_filter) {
  console.log(sts_array, emp_id, receive_filter);
